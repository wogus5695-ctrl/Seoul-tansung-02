...
export const DIAGNOSIS_ITEMS = {
  ...
  "laundry-humidity": {
    id: "laundry-humidity",
    title: "세탁실 배관 및 주변 습기 점검",
    content: "세탁기 배수 주변이나 배관 연결부, 수도 설비 인근의 물자국은 지속적인 습도 상승의 원인이 될 수 있습니다. 물 흔적이 특정 설비에 집중된다면 탄성코트 전 설비·누수 점검을 먼저 검토해야 하며, 외벽 접점이나 창 주변의 습기는 온도차 및 환기 상태에 따른 결로 가능성도 함께 확인합니다.",
    category: "elasticCoat"
  },
  "elastic-peeling": {
    id: "elastic-peeling",
