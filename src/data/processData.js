  ...
  principles: [
    {
      ...
      id: "surface-check",
      title: "기존 표면 상태 확인",
      desc: "벽면의 오염과 들뜸, 균열, 수분 흔적 또는 타일 틈의 마모와 기존 백시멘트 상태를 먼저 확인합니다."
    },
    {
      num: "02",
      id: "scope-division",
      title: "작업 범위 구분",
      desc: "단순 표면 정리로 가능한 부분과 제거, 보수 또는 추가 확인이 필요한 부분을 구분해 안내합니다."
    },
    {
      num: "03",
      id: "space-protection",
      title: "주변 공간 보양",
      desc: "창호와 바닥, 배관, 문틀, 타일 등 작업 대상이 아닌 주변 요소를 보호할 수 있도록 보양 범위를 설정합니다."
    },
    {
      num: "04",
      id: "step-execution",
      title: "공정별 시공",
      desc: "기초 정리부터 재료 적용과 마감까지 각 단계가 뒤섞이지 않도록 순서에 맞춰 작업합니다."
    },
    {
      num: "05",
      id: "final-review",
      title: "마감 상태 확인",
      desc: "작업 부위의 균일도와 오염 여부, 주변 보양 상태를 확인한 뒤 공간을 정리합니다."
    }
  ]
};
